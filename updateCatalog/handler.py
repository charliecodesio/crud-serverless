        ...
        if event['httpMethod'] == 'PUT':
            ...
            if responseValidate['status']:
                ...
                if respuesta['statusCode'] == 200:
                    respuesta = {"statusCode": 200, "body": 'Se actualizo correctamente el suscriptor'}
                else:
...
def validateInfo(body):
    ...
    if infoSuscriptor == None:
        ...
        response['query'] = "UPDATE suscriptores SET nombre = '%s', apellido_materno = '%s', apellido_paterno = '%s', edad = %s WHERE telefono_celular = '%s'" %(nombre, apellido_materno, apellido_paterno, edad, telefono_celular)
    return response 